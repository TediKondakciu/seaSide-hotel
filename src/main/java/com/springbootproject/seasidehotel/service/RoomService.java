...
import com.springbootproject.seasidehotel.exception.InternalServerException;
...
public class RoomService implements IRoomService {
    ...
    public Room addNewRoom(MultipartFile file, String roomType, BigDecimal roomPrice) throws SQLException, IOException {
        ...
        if(!file.isEmpty()){
            ...
            Blob photo = new SerialBlob(photoBytes);
            room.setPhoto(photo);
        }
    ...
    public byte[] getRoomPhotoByRoomId(Long roomId) throws SQLException, ResourceNotFoundException {
        ...
        if(theRoom.isEmpty()){
            throw new ResourceNotFoundException("RoomNotFound");
        }
